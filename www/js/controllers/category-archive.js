...
.controller('CategoryArchiveCtrl', function($scope, $ionicModal, $timeout, $rootScope, $sce, $localstorage, $ionicPopup, category, Post, Bookmark) {
	...
	$scope.bookmarkThis = function(item){
		...
		var alertPopup = $ionicPopup.alert({
			title: 'Saved!',
			template: 'Voce pode ler esse noticia mais tarde.'
		});
